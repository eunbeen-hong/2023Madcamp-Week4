                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            height:
                                10), // Add vertical spacing between the title and books
                        Container(
                          height: 150,
                          color: Color(0xffffffff),
                          child: ListView.builder(
                            ...
                            itemCount:
                                userInfo!.categories[index].bookIdList.length,
                            itemBuilder: (BuildContext context, int hIndex) {
                              String bookId = userInfo!
                                  .categories[index].bookIdList[hIndex];
                              BookDB? book = userInfo!.books
                                  .firstWhere((b) => b.bookId == bookId);
                              String defaultImageUrl =
                                  ''; // TODO: find default book cover url
